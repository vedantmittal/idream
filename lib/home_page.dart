          ...
          children: [
            GestureDetector(
              ...
              child: Row(
                mainAxisSize: MainAxisSize.min,
                children: const [
                   Text('Class 9', style: TextStyle(fontSize: 12, color: Colors.blue, fontWeight: FontWeight.w500),),
                   Icon(Icons.expand_more_sharp, color: Colors.blue,)
                ],
              ),
              ),
            ),
            ...
            GestureDetector(
              ...
              child: Container(decoration: BoxDecoration(
                ...
                child: Row(
                  mainAxisSize: MainAxisSize.min,
                  children:const [
                     Text('Eng', style: TextStyle(fontSize: 12, color: Colors.blue, fontWeight: FontWeight.w500),),
                     Icon(Icons.expand_more_sharp, color: Colors.blue,)
                  ],
                ),
              ),
